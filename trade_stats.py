...
def get_trade_metrics(flow_type: str):
    if flow_type == "Exports":
        data = {
            ...
            "Primary PH Export Sectors": ["Semiconductors & Electronics", "Ignition Wiring Sets", "Machinery & Transport Equip.", "Processed Foods & Beverages", "Coconut Oil & Derivatives"]
        }
    else:
        data = {
            "Rank": list(range(1, 11)),
            ...
            "Primary PH Import Sectors": ["Electronic Components", "Mineral Fuels & Refined Petroleum", "Iron, Steel & Metal Manufactures", "Cereals & Industrial Machinery", "Plastics & Chemical Products"]
        }
